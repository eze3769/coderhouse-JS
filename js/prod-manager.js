...
function verifyNotNull(name,description,price,category,imageFile){
  var isNull = false;
  if (name == ""){
    document.getElementById("input-name-alert").innerText = "¡Ingrese un nombre!";
    isNull = true;
  }else{
    document.getElementById("input-name-alert").innerText = "";
  }
  if (price == ""){
    document.getElementById("input-price-alert").innerText = "¡Ingrese un precio!";
    isNull = true;
  }else{
  ...
  if (category == ""){
    document.getElementById("input-category-alert").innerText = "¡Ingrese una categoría!";
    isNull = true;
  }else{
    document.getElementById("input-category-alert").innerText = "";
  }
  if (imageFile == undefined){
    document.getElementById("input-image-alert").innerText = "¡Ingrese una imágen!";
    isNull = true;
  }else{
    document.getElementById("input-image-alert").innerText = "";
  }
  if (description == ""){
    document.getElementById("input-description-alert").innerText = "¡Ingrese una descripción!";
    isNull = true;
  }else{
...
function CloseAlert(){
  ...
  function ProductPreview(){
    ...
    exist = true;
      ...
      document.getElementById("alert__message").innerText="Para previsualizar ingrese todos los datos";
      $("#body__alert").show();
    }
...
function CategoryAdd(){
  var category = document.getElementById("input__newCategory").value.toLowerCase();
  if(category != ""){
    var db = firebase.database().ref('categories').push();
        db.set(category).then(function(){
          document.getElementById("categoryAdd__form").reset();
          document.getElementById("alert__message").innerText="Categoría agregada con éxito";
    ...
    document.getElementById("alert__message").innerText="Ingrese una categoría";
    $("#body__alert").show(); 
  }
}
